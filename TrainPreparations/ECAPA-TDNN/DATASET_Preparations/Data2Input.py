...
def waveform_to_pcen(
    ...
    """
    Convert waveform (1, T) -> PCEN mel spectrogram (T_frames, n_mels)

    Output shape matches waveform_to_logmel().
    """
    ...
    pcen = torch.from_numpy(pcen).float()

    # (n_mels, T) -> (T, n_mels)
    pcen = pcen.transpose(0, 1)
...
if __name__ == "__main__":
    ...
    output_dir = "C:/PHD/SideProjects/Vlad214/DATABASE/TEST_PT_ECAPATDNN_ORG_GB_96/"
